import{s as _,B as A,r as b,p as E,j as D,b as x,o as p,d as g,e,t as c,k as C,g as h,f as P,w as S}from"./vendor-7ddbb7ec.js";import{_ as $}from"./index-4ce865bf.js";const I={async printThermalTicket(i){try{const s=window.open("","","width=400,height=600");if(!s)return console.error("No se pudo abrir la ventana de impresión"),!1;const n=this.generateThermalHTML(i);return s.document.write(n),s.document.close(),s.onload=()=>{s.print(),setTimeout(()=>{s.close()},1e3)},!0}catch(s){return console.error("Error al imprimir:",s),!1}},async printMultipleTickets(i){try{const s=window.open("","","width=400,height=600");if(!s)return console.error("No se pudo abrir la ventana de impresión"),!1;let n=`
        <!DOCTYPE html>
        <html>
        <head>
          <meta charset="UTF-8">
