import{p as _e,x as xe,r as v,k as A,s as Se,y as Ae,b as we,o as w,d as k,e as s,t as n,m as V,g as M,F as ke,n as Te,f as Ce,w as De,v as Ee}from"./vendor-8f3c8a00.js";import{_ as Pe,u as Ie,p as $e}from"./index-6d6026e0.js";const J={async printThermalTicket(o){try{const a=window.open("","","width=400,height=600");if(!a)return console.error("No se pudo abrir la ventana de impresión"),!1;const p=this.generateThermalHTML(o);return a.document.write(p),a.document.close(),a.onload=()=>{a.print(),setTimeout(()=>{a.close()},1e3)},!0}catch(a){return console.error("Error al imprimir:",a),!1}},async printMultipleTickets(o){try{const a=window.open("","","width=400,height=600");if(!a)return console.error("No se pudo abrir la ventana de impresión"),!1;let p=`
        <!DOCTYPE html>
        <html>
        <head>
          <meta charset="UTF-8">
