import{n as me,r as g,j as x,s as ve,b as pe,o as w,d as k,e as t,t as n,l as M,g as R,F as ge,m as be,f as fe,w as he,v as ye}from"./vendor-89c651cf.js";import{p as Ne}from"./paymentService-982184ed.js";import{_ as _e,u as Ae}from"./index-889aa2ce.js";const U={async printThermalTicket(r){try{const a=window.open("","","width=400,height=600");if(!a)return console.error("No se pudo abrir la ventana de impresión"),!1;const u=this.generateThermalHTML(r);return a.document.write(u),a.document.close(),a.onload=()=>{a.print(),setTimeout(()=>{a.close()},1e3)},!0}catch(a){return console.error("Error al imprimir:",a),!1}},async printMultipleTickets(r){try{const a=window.open("","","width=400,height=600");if(!a)return console.error("No se pudo abrir la ventana de impresión"),!1;let u=`
        <!DOCTYPE html>
        <html>
        <head>
          <meta charset="UTF-8">
