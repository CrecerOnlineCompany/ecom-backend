import{n as _e,x as xe,r as v,j as A,s as Se,y as Ae,b as we,o as w,d as k,e as s,t as n,l as V,g as M,F as ke,m as Te,f as Ce,w as De,v as Ee}from"./vendor-89c651cf.js";import{p as Pe}from"./paymentService-15c90791.js";import{_ as Ie,u as $e}from"./index-4d458a29.js";const J={async printThermalTicket(o){try{const a=window.open("","","width=400,height=600");if(!a)return console.error("No se pudo abrir la ventana de impresión"),!1;const p=this.generateThermalHTML(o);return a.document.write(p),a.document.close(),a.onload=()=>{a.print(),setTimeout(()=>{a.close()},1e3)},!0}catch(a){return console.error("Error al imprimir:",a),!1}},async printMultipleTickets(o){try{const a=window.open("","","width=400,height=600");if(!a)return console.error("No se pudo abrir la ventana de impresión"),!1;let p=`
        <!DOCTYPE html>
        <html>
        <head>
          <meta charset="UTF-8">
