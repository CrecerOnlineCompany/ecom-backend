import{C as W,r as v,p as D,j as Y,b as G,o as N,d as _,e as t,t as d,k as P,g as C,f as K,w as Q,n as X}from"./vendor-d71df2f6.js";import{p as Z}from"./paymentService-57db93aa.js";import{_ as ee}from"./index-8366a96a.js";const x={async printThermalTicket(l){try{const s=window.open("","","width=400,height=600");if(!s)return console.error("No se pudo abrir la ventana de impresión"),!1;const u=this.generateThermalHTML(l);return s.document.write(u),s.document.close(),s.onload=()=>{s.print(),setTimeout(()=>{s.close()},1e3)},!0}catch(s){return console.error("Error al imprimir:",s),!1}},async printMultipleTickets(l){try{const s=window.open("","","width=400,height=600");if(!s)return console.error("No se pudo abrir la ventana de impresión"),!1;let u=`
        <!DOCTYPE html>
        <html>
        <head>
          <meta charset="UTF-8">
