import{p as _e,x as Se,r as p,k as w,s as we,y as Ae,b as ke,o as A,d as k,e as a,t as n,m as Y,g as B,F as Te,n as Ce,f as De,w as Ee,v as Ie}from"./vendor-8f3c8a00.js";import{_ as Pe,u as Re,p as $e}from"./index-9f2f0e74.js";const G={async printThermalTicket(i){try{const s=window.open("","","width=400,height=600");if(!s)return console.error("No se pudo abrir la ventana de impresión"),!1;const m=this.generateThermalHTML(i);return s.document.write(m),s.document.close(),s.onload=()=>{s.print(),setTimeout(()=>{s.close()},1e3)},!0}catch(s){return console.error("Error al imprimir:",s),!1}},async printMultipleTickets(i){try{const s=window.open("","","width=400,height=600");if(!s)return console.error("No se pudo abrir la ventana de impresión"),!1;let m=`
        <!DOCTYPE html>
        <html>
        <head>
          <meta charset="UTF-8">
