import{C as K,r as v,p as D,j as Q,b as X,o as N,d as _,e as t,t as d,k as x,g as E,f as Z,w as ee,n as te}from"./vendor-d71df2f6.js";import{p as ae}from"./paymentService-0ad48eea.js";import{_ as se,u as ne}from"./index-21e73a0e.js";const I={async printThermalTicket(l){try{const s=window.open("","","width=400,height=600");if(!s)return console.error("No se pudo abrir la ventana de impresión"),!1;const u=this.generateThermalHTML(l);return s.document.write(u),s.document.close(),s.onload=()=>{s.print(),setTimeout(()=>{s.close()},1e3)},!0}catch(s){return console.error("Error al imprimir:",s),!1}},async printMultipleTickets(l){try{const s=window.open("","","width=400,height=600");if(!s)return console.error("No se pudo abrir la ventana de impresión"),!1;let u=`
        <!DOCTYPE html>
        <html>
        <head>
          <meta charset="UTF-8">
